      ...
      <ul class="navbar-nav gap-1 nav-right-links align-items-center">
                  ...
                  <div class="card rounded-4 shadow-none border mb-0">
                    <div class="card-body">
                      <div class="d-flex align-items-start gap-3">
                        ...
                        <img src="<?php echo base_url() ?>assets/images/megaIcons/06.png" width="40" alt="">
            ...
            <div class="border rounded-4 overflow-hidden">
              <div class="row row-cols-3 g-0 border-bottom">
                ...
                <div class="col">
                  <div class="app-wrapper d-flex flex-column gap-2 text-center">
                    <div class="app-icon">
                      <img src="<?php echo base_url() ?>assets/images/apps/03.png" width="36" alt="">
                    </div>
                    <div class="app-name">
        ...
        <li class="nav-item dropdown">
          <a href="javascrpt:;" class="dropdown-toggle dropdown-toggle-nocaret" data-bs-toggle="dropdown">
             <img src="<?php echo base_url() ?>assets/images/avatars/01.png" class="rounded-circle p-1 border" width="45" height="45">
          </a>
