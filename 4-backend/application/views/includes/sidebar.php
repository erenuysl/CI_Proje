<aside class="sidebar-wrapper">
    ...
    <div class="sidebar-bottom gap-4">
        ...
        <div class="dropdown dropup-center dropup dropdown-laungauge">
          <a class="dropdown-toggle dropdown-toggle-nocaret footer-icon" href="avascript:;" data-bs-toggle="dropdown"><img src="<?php echo base_url() ?>assets/images/county/02.png" width="22" alt="">
          </a>
