          ...
          <div class="col-12 col-lg-12">
						<div class="card">
							<div class="card-body p-4">
								<form method="POST" action="<?php echo base_url("Product_Category/update/$item->id") ?>">
								<h5 class="mb-4">Ürün Kategorisi Düzenleme İşlemi</h5>
									<div class="row mb-3">
									...
									<div class="row">
										...
										<div class="col-sm-9">
											<div class="d-md-flex d-grid align-items-center gap-3">
												...
												<a href="<?php echo base_url("product_category")?>" type="button" class="btn btn-light px-4">Vazgeç</a>
											</div>
										</div>
									</div>
